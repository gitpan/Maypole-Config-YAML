# This Makefile is for the Maypole::Config::YAML extension to perl.
#
...
#     NAME => q[Maypole::Config::YAML]
#     PREREQ_PM => { YAML=>q[0] }
#     VERSION_FROM => q[YAML.pm]
...
FULLEXT = Maypole/Config/YAML
BASEEXT = YAML
PARENT_NAME = Maypole::Config
DLBASE = $(BASEEXT)
...
INST_LIBDIR      = $(INST_LIB)/Maypole/Config
INST_ARCHLIBDIR  = $(INST_ARCHLIB)/Maypole/Config
...
PM_TO_BLIB = YAML.pm \
	$(INST_LIB)/Maypole/Config/YAML.pm
...
DISTNAME = Maypole-Config-YAML
DISTVNAME = Maypole-Config-YAML-0.1
...
manifypods : pure_all  \
	...
	$(NOECHO) $(POD2MAN) --section=3pm --perm_rw=$(PERM_RW)\
	  YAML.pm $(INST_MAN3DIR)/Maypole::Config::YAML.$(MAN3EXT) 
...
realclean purge ::  clean realclean_subdirs
	...
	$(RM_RF) $(DISTVNAME)
	$(RM_F)  $(INST_LIB)/Maypole/Config/YAML.pm $(MAKEFILE_OLD) $(FIRST_MAKEFILE)
...
metafile :
	...
	$(NOECHO) $(ECHO) 'name:         Maypole-Config-YAML' >> META.yml
	$(NOECHO) $(ECHO) 'version:      0.1' >> META.yml
	$(NOECHO) $(ECHO) 'version_from: YAML.pm' >> META.yml
...
pm_to_blib: $(TO_INST_PM)
	$(NOECHO) $(PERLRUN) -MExtUtils::Install -e 'pm_to_blib({@ARGV}, '\''$(INST_LIB)/auto'\'', '\''$(PM_FILTER)'\'')'\
	  YAML.pm $(INST_LIB)/Maypole/Config/YAML.pm 
	$(NOECHO) $(TOUCH) $@
